...
const CTA = () => {
    return (
        <div>
            <section className="text-gray-100 body-font my-10">
                <div className="container mx-auto flex px-5 py-5 md:flex-row items-center">
                    <div className="lg:max-w-lg lg:w-full md:w-2/3 w-5/6">
                        <img className="object-cover object-center rounded" alt="hero" src="https://i.ibb.co/7KHR3YL/cta-img.png" />
                    </div>
                    <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                        <h1 className="title-font text-4xl md:text-4xl mb-4 font-bold text-accent">🚀🌟 Ready to Bring Your Ideas to Life?
                            <span className="hidden lg:inline-block text-white">Let's Create Something Amazing Together! 🚀✨</span>
                        </h1>
